...
D(mp_result, 'mp_int_read_cstring', mp_int, mp_size, PTR(c_byte),
  PTR(PTR(c_byte)))
...
class mpz(mpz_t):
    ...
    def __add__(self, other):
        t = mpz()
        check_ok(_lib.mp_int_add(self, other, t))
        return t
    ...
    def __sub__(self, other):
        t = mpz()
        check_ok(_lib.mp_int_sub(self, other, t))
        return t
    ...
    def __mul__(self, other):
        t = mpz()
        check_ok(_lib.mp_int_mul(self, other, t))
        return t
